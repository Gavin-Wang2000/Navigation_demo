...
echo_and_run cd "/home/wang/Desktop/Navigation_Demo/src/arbotix_ros/arbotix_sensors"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/wang/Desktop/Navigation_Demo/src/arbotix_ros/arbotix_sensors/setup.py" \
     \
    build --build-base "/home/wang/Desktop/Navigation_Demo/build/arbotix_ros/arbotix_sensors" \
    install \
    --root="${DESTDIR-/}" \
