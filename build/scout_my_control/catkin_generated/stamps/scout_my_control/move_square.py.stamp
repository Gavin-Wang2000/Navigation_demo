...
class RunRectangle():  
    def __init__(self):  
        rospy.init_node('run_rectangle', anonymous=False)  
        ...
        waypoints.append(Pose(Point(5.0, 5.0, 0.0), quaternions[1]))  
        waypoints.append(Pose(Point(1.0, 5.0, 0.0), quaternions[2]))  
        waypoints.append(Pose(Point(1.0, 2.0, 0.0), quaternions[3]))  
